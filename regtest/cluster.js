...
describe('Bitcoin Cluster', function() {
  var node;
  var daemons = [];
  var execPath = path.resolve(__dirname, '../bin/kotod');
  var nodesConf = [
    {
      datadir: path.resolve(__dirname, './data/node1'),
      conf: path.resolve(__dirname, './data/node1/koto.conf'),
      rpcuser: 'bitcoin',
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node2/koto.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30522,
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node3/koto.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30523,
